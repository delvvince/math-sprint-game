...
// Refresh Spash Page Best Scores
...
function scoresToDOM() {
  ...
  // Populate DOM with fixed decimal numbers
...
function checkTime() {
  ...
  if (playerGuessArray.length == questionAmount) {
    ...
    clearInterval(timer);
    // Check for wong guesses, add penalty time
...
function populateGamePage() {
  ...
  console.log('game page populated.')
}
